    ...
    reader.onload = (e) => {
      ...
      try {
        ...
        if (parsedStrategy.entryRules && parsedStrategy.exitRules) {
          ...
          console.error("Invalid strategy file format");
        }
      } catch (error) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-slate-900 font-bold text-lg">AssetMaster Strategy Builder</h1>
                <p className="text-xs text-slate-500">Visual trading rule creator & backtester</p>
              </div>
            </div>
